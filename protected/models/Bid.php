...
class Bid extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('UserID, UserPropertyID, Price', 'required'),
			array('UserID, UserPropertyID, Price', 'numerical', 'integerOnly'=>true),
            array('IsSold', 'boolean'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('UserID, UserPropertyID, Price, IsSold', 'safe', 'on'=>'search'),
		);
	}
