...
class Picture extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('UserPropertyID', 'required'),
			array('UserPropertyID, IsActive', 'numerical', 'integerOnly'=>true),
			array('PictureUrl', 'file','types'=>'jpg, png', 'allowEmpty'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('PictureID, PictureUrl, UserPropertyID, IsActive', 'safe', 'on'=>'search'),
	...
	public function relations()
	{
		...
		return array(
			'userProperty' => array(self::BELONGS_TO, 'Userproperty', 'UserPropertyID'),
		);
	}
