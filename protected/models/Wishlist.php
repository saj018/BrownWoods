...
class Wishlist extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('UserID, UserPropertyID', 'required'),
			array('UserID, UserPropertyID, IsActive', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('UserID, UserPropertyID, IsActive', 'safe', 'on'=>'search'),
		);
	}
